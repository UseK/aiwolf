package agent.aiwolf.kajiClient.lib;
...
public class PatternMaker {
	...
	public void extendPatternList(List<Pattern> patterns, Agent coAgent, Role coRole, AdvanceGameInfo advanceGameInfo){
		...
		for(Pattern pattern: patterns){
			...
			//真能力者がいない
				...
				newPattern1.getComingoutMap().put(coAgent, coRole);
				newPattern2.getComingoutMap().put(coAgent, coRole);
	...
	public void updateExecutedData(List<Pattern> patterns, Agent executedAgent){
		for(Pattern pattern: patterns){
